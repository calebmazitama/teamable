<template>
    <div v-show="!isEditMode">
            <h1>User profile</h1>
            <img src="https://gitlab.com/nanuchi/it-beginners-course/-/raw/feature/html-css-vuejs/src/profile.jpeg">
...
export default {
    ...
    methods: {
        ...
        async handleUpdateProfile() {
            ...
            const resJson = await this.updatedUserProfile(payload)
            console.log(resJson)
        ...
        async updatedUserProfile(payload) {
